...
public class App16 {
  ...
  public static void main(String[] args) {
    ...
    loop: while (true) {
      ...
      switch (command) {
        case "list": BoardHandler2.list(); break;
        case "add": BoardHandler2.add(); break;
        case "update": BoardHandler2.update(); break;
        case "delete": BoardHandler2.delete(); break;
        case "view": BoardHandler2.view(); break;
        case "quit":
          break loop;
        default:
